 ...
 * from the files:
 * <pre>
 *  g:\\music_project\\music_project_matlab\\hw.m
 * </pre>
...
public class Class1 extends MWComponentInstance<Class1>
{
    ...
    {
        this(HwMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    ...
    {
        this(HwMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = HwMCRFactory.newInstance();
